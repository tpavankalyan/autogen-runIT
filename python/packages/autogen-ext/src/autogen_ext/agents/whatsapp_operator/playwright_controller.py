...
class PlaywrightController:
    ...
    async def get_visual_viewport(self, page: Page) -> VisualViewport:
        ...
        try:
            ...
            pass
        return visualviewport_from_dict(await page.evaluate("WhatsappOperator.getVisualViewport();"))
    ...
    async def get_focused_rect_id(self, page: Page) -> str | None:
        ...
        try:
            ...
            pass
        result = await page.evaluate("WhatsappOperator.getFocusedElementId();")
    ...
    async def get_page_metadata(self, page: Page) -> Dict[str, Any]:
        ...
        try:
            ...
            pass
        result = await page.evaluate("WhatsappOperator.getPageMetadata();")
        assert isinstance(result, dict)
    ...
    async def page_down(self, page: Page) -> None:
        """
        Scroll the currently focused part down by 1000 pixels. Make sure to click on the part fo the page you want to scroll first.
    ...
    async def page_up(self, page: Page) -> None:
        """
        Scroll the currently focused part up by 1000 pixels. Make sure to click on the part fo the page you want to scroll first.
    ...
    async def get_visible_text(self, page: Page) -> str:
        ...
        try:
            ...
            pass
        result = await page.evaluate("WhatsappOperator.getVisibleText();")
